---
title: "Node.js/Python/Go完全対応のCLI開発本を書きました（3言語で2000円）"
emoji: "💻"
type: "tech"
...
そう思って、**3言語完全対応で2000円の本**を書きました。

## 💻 CLI開発・自動化実践ガイド - Node.js/Python/Go完全対応
...
👉 **[Zennで今すぐ読む（2000円）](https://zenn.dev/gaku1234/books/cli-automation-complete-guide)**
...
**たった2000円で、3言語のCLI開発をマスター。**

実質8,500円お得で、時間も大幅に節約できます。

👉 **[今すぐ読む（2000円）](https://zenn.dev/gaku1234/books/cli-automation-complete-guide)**
