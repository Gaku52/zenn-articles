...
この記事では、想定シナリオに基づく3つの最適化手法を解説します。数値は一般的なベンチマークに基づく想定値です。
...
特に問題になりやすいのは、**開発者が平均30分×20回=10時間/日もCI完了を待っている**という状況です。

## 想定される改善効果：3つの最適化で-83%削減

適切に最適化を実装することで、以下のような改善が見込めます。
