...
- **READMEが不十分だと感じるプロジェクト：73%**
- **API仕様書とコードが乖離している経験：81%**
- **ドキュメントの更新を忘れた経験：89%**
- **「実測しました」などの表現の使い方に迷う：68%**
...
## 実際の事例：OSSライブラリのREADME改善

本書の第7章では、実際のOSSライブラリのREADME改善事例を紹介しています。ここではその概要を説明します。

### 改善前の課題

**プロジェクト:** TypeScript用のバリデーションライブラリ
**問題点:**
...
| 指標 | Before | After | 改善率 |
|------|--------|-------|--------|
| GitHub Stars | 120 | 1,200 | 900% |
| 週間ダウンロード | 450 | 12,000 | 2,567% |
| Issue解決時間 | 3日 | 1日 | 67% |
| コントリビューター | 3人 | 28人 | 833% |
