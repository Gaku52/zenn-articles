...
本書は、実務に役立つ知見とベンチマーク指標をもとに、フロントエンドパフォーマンス最適化のすべてを体系的に解説する完全ガイドです。
...
- 想定される効果に基づく改善シナリオ（LCP 4.5s→1.2s、INP 300ms→50ms）
